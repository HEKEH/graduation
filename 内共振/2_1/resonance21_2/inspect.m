...
temp_omega = omega_n;
x = 0.5;
temp_target = PHI3(x)-PHI6(x)-I3 - m * J_n * phi_c(x, n_idx);
...
simplify(matr_A_sym * C_k_sym -  vec_b_sym)
eval(matr_A_sym) * eval(C_k_sym) - eval(vec_b_sym)
eval(matr_A_sym * C_k_sym) - eval(vec_b_sym)